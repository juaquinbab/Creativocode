...
const INSTRUCCIONES_PATH = path.resolve(__dirname, '../../data/instruciones8.json'); // ojo con el nombre
const ETAPAS_PATH = path.resolve(__dirname, '../../data/EtapasMSG8.json');
