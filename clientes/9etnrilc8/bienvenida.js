...
const registroPath = path.join(__dirname, "bienvenida8.json");
const etapasPath   = path.join(__dirname, "../../data/EtapasMSG8.json");
const usuariosPath = path.join(__dirname, "../../data/usuarios.json");

// ⬇️ Ruta del archivo que contiene el texto (se mantiene tal cual)
const textoPath    = path.join(__dirname, "../../data/textoclinete8.json");
