...
const INSTRUCCIONES_PATH = path.resolve(__dirname, '../../data/instruciones5.json'); // ojo con el nombre
const ETAPAS_PATH = path.resolve(__dirname, '../../data/EtapasMSG5.json');
