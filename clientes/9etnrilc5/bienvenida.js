...
const registroPath = path.join(__dirname, "bienvenida5.json");
const etapasPath   = path.join(__dirname, "../../data/EtapasMSG5.json");
const usuariosPath = path.join(__dirname, "../../data/usuarios.json");

// ⬇️ Ruta del archivo que contiene el texto (se mantiene tal cual)
const textoPath    = path.join(__dirname, "../../data/textoclinete5.json");
