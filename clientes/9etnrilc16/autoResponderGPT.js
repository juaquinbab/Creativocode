...
const INSTRUCCIONES_PATH = path.resolve(__dirname, "../../data/instruciones16.json");
const ETAPAS_PATH = path.resolve(__dirname, "../../data/EtapasMSG16.json");
...
function getIDNUMERO() {
  try {
    ...
    return usuariosData?.cliente16?.iduser || "";
  } catch (err) {
