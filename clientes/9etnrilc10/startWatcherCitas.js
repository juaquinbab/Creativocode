...
const ETA_PATH = path.join(__dirname, "../../data/EtapasMSG10.json");
...
function getWabaPhoneId() {
  try {
    ...
    return usuariosData?.cliente10?.iduser || '';
  } catch (e) {
...
const PALABRAS_CONFIRMACION = ["gdfvvvvxcyy", "uytutyugggggv"]; // cubre varias formas
