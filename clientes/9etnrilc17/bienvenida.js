...
const registroPath = path.join(__dirname, "bienvenida17.json");
const etapasPath   = path.join(__dirname, "../../data/EtapasMSG17.json");
const usuariosPath = path.join(__dirname, "../../data/usuarios.json");

// ⬇️ Ruta del archivo que contiene el texto (se mantiene tal cual)
const textoPath    = path.join(__dirname, "../../data/textoclinete17.json");
