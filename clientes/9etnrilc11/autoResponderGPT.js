...
const INSTRUCCIONES_PATH = path.resolve(__dirname, '../../data/instruciones11.json'); // ojo con el nombre
const ETAPAS_PATH = path.resolve(__dirname, '../../data/EtapasMSG11.json');
...
function getIDNUMERO() {
  try {
    ...
    return usuariosData?.cliente11?.iduser || '';
  } catch (err) {
